 ...
 * @author MISAEL
 */
public class Modificar_constancia extends javax.swing.JFrame {
    int num_panel;
    ...
    private void initComponents() {
        ...
        tb_testigo_tres_nombre.setText("-");
        ...
        label_imagen.setBounds(0, 0, 1373, 1080);
    ...
    private void bt_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_actualizarActionPerformed
        ...
        int id_terreno = Integer.parseInt(Lista_constancias.get(0)[10]);
        ...
        int id_propietario = Integer.parseInt(Lista_constancias.get(0)[6]);
       ...
       if(testigo.Modificar())
            System.out.println("TESTIGO 1");
       
       int id_testigo2 = Integer.parseInt(Lista_testigos.get(1)[0]);
       ...
       int id_comite_anterior = Integer.parseInt(Lista_com_eji.get(0)[0]);
       com_eji_autoriza.setFolio_constancia(id_constancia);
       com_eji_autoriza.setId_autoriza(id_comite);
       if(com_eji_autoriza.Modificar(id_comite_anterior))
       ...
       id_comite_anterior = Integer.parseInt(Lista_com_eji.get(1)[0]);
       com_eji_autoriza.setFolio_constancia(id_constancia);
       com_eji_autoriza.setId_autoriza(id_comite);
       if(com_eji_autoriza.Modificar(id_comite_anterior))
       ...
       id_comite= Integer.parseInt(auxiliar_id[0]);
       id_comite_anterior = Integer.parseInt(Lista_com_eji.get(2)[0]);
       com_eji_autoriza.setFolio_constancia(id_constancia);
       com_eji_autoriza.setId_autoriza(id_comite);
       if(com_eji_autoriza.Modificar(id_comite_anterior))
       ...
       id_comite= Integer.parseInt(auxiliar_id[0]);
       id_comite_anterior = Integer.parseInt(Lista_con_vig.get(2)[0]);
       con_vig_autoriza.setFolio_consatncia(id_constancia);
       con_vig_autoriza.setId_autoriza(id_comite);
       if(con_vig_autoriza.Modificar(id_comite_anterior))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_constancia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modificar_constancia().setVisible(true);
    ...
    public void Establecer_info(){
        
        
        Constancia constancia = new Constancia();
        this.Lista_constancias = constancia.Buscar_todo(2,this.no_constancia);
        this.Lista_testigos = constancia.Buscar_testigos(2,this.no_constancia);
        this.Lista_con_vig = constancia.Buscar_con_vig(2,this.no_constancia);
        this.Lista_com_eji = constancia.Buscar_com_ejidal(2,this.no_constancia);
        this.croquis = constancia.Buscar_croquis(this.no_constancia);
        
        tb_folio.setText(Lista_constancias.get(0)[0]);
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        try {
        ...
        tb_propietario_nombre.setText(Lista_constancias.get(0)[7]);
        tb_propietario_appat.setText(Lista_constancias.get(0)[8]);
        tb_propietario_apmat.setText(Lista_constancias.get(0)[9]);
        tb_ubicacion_terreno.setText(Lista_constancias.get(0)[11]);
        ...
        tb_med_n.setText(Lista_constancias.get(0)[13]);
        tb_col_n.setText(Lista_constancias.get(0)[14]);
        tb_med_s.setText(Lista_constancias.get(0)[15]);
        tb_col_s.setText(Lista_constancias.get(0)[16]);
        tb_med_e.setText(Lista_constancias.get(0)[17]);
        tb_col_e.setText(Lista_constancias.get(0)[18]);
        tb_med_o.setText(Lista_constancias.get(0)[19]);
        tb_col_o.setText(Lista_constancias.get(0)[20]);
        tb_med_ne.setText(Lista_constancias.get(0)[21]);
        tb_col_ne.setText(Lista_constancias.get(0)[22]);
        tb_med_no.setText(Lista_constancias.get(0)[23]);
        tb_col_no.setText(Lista_constancias.get(0)[24]);
        tb_med_se.setText(Lista_constancias.get(0)[25]);
        tb_col_se.setText(Lista_constancias.get(0)[26]);
        tb_med_so.setText(Lista_constancias.get(0)[27]);
        tb_col_so.setText(Lista_constancias.get(0)[28]);
        ta_nota.setText(Lista_constancias.get(0)[29]);
        
        tb_testigo_uno_nombre.setText(Lista_testigos.get(0)[1]);
        tb_testigo_uno_appat.setText(Lista_testigos.get(0)[2]);
        tb_testigo_uno_apmat.setText(Lista_testigos.get(0)[3]);
        tb_testigo_dos_nombre.setText(Lista_testigos.get(1)[1]);
        tb_testigo_dos_appat.setText(Lista_testigos.get(1)[2]);
        tb_testigo_dos_apmat.setText(Lista_testigos.get(1)[3]);
        
        for (int i = 0; i < cb_ce_presidente.getItemCount(); i++) {
            String[] cadena_partida = cb_ce_presidente.getItemAt(i).toString().split(",");
            if(cadena_partida[0].equals(Lista_com_eji.get(0)[0])){
                cb_ce_presidente.setSelectedIndex(i);
            }
        }
        for (int i = 0; i < cb_ce_secretario.getItemCount(); i++) {
            String[] cadena_partida = cb_ce_secretario.getItemAt(i).toString().split(",");
            if(cadena_partida[0].equals(Lista_com_eji.get(1)[0])){
                cb_ce_secretario.setSelectedIndex(i);
            }
        }
        for (int i = 0; i < cb_ce_tesorero.getItemCount(); i++) {
            String[] cadena_partida = cb_ce_tesorero.getItemAt(i).toString().split(",");
            if(cadena_partida[0].equals(Lista_com_eji.get(2)[0])){
                cb_ce_tesorero.setSelectedIndex(i);
            }
        }
         for (int i = 0; i < cb_cv_presidente.getItemCount(); i++) {
            String[] cadena_partida = cb_cv_presidente.getItemAt(i).toString().split(",");
            if(cadena_partida[0].equals(Lista_con_vig.get(0)[0])){
                cb_cv_presidente.setSelectedIndex(i);
            }
        }
        for (int i = 0; i < cb_cv_secretario.getItemCount(); i++) {
            String[] cadena_partida = cb_cv_secretario.getItemAt(i).toString().split(",");
            if(cadena_partida[0].equals(Lista_con_vig.get(1)[0])){
                cb_cv_secretario.setSelectedIndex(i);
            }
        }
        for (int i = 0; i < cb_cv_secretario_dos.getItemCount(); i++) {
            String[] cadena_partida = cb_cv_secretario_dos.getItemAt(i).toString().split(",");
            if(cadena_partida[0].equals(Lista_con_vig.get(2)[0])){
                cb_cv_secretario_dos.setSelectedIndex(i);
            }
        }
